...
-- Enable global animations engine
hl.config({
    animations = {
        enabled = true
    }
...
-- Custom Bézier curves coordinate mapping
...
hl.curve("nice", { type = "bezier", points = { { -0, 1 }, { 0.5, -1 } } })

-- Animation node assignments via API properties
